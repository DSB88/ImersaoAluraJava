...
//                         .openStream();
        ...
        graphics.drawString("Mensagem de Texto", 100, novaAltura - 100);
    ...
    public static void main(String[] args) throws Exception {
         InputStream inputStream =
                         new URL("https://m.media-amazon.com/images/M/MV5BMDFkYTc0MGEtZmNhMC00ZDIzLWFmNTEtODM1ZmRlYWMwMWFmXkEyXkFqcGdeQXVyMTMxODk2OTU@.jpg")
                         .openStream();
        GeradoraDeFigurinhas g = new GeradoraDeFigurinhas();
        g.cria(inputStream,"API/saida/nomeCriar.jpg");
    }
